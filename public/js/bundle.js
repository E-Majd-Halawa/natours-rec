...
const $8f9e48ecb391b951$export$596d806903d1f59e = async (email, password) => {
  try {
    ...
    if (data1.status === 'success') {
      (0, $9872a30d54cb2189$export$de026b00723010c1)(
        'success',
      ...
      (0, $9872a30d54cb2189$export$de026b00723010c1)('error', data1.message); // ← هاد بيطلع 'Incorrect email or password'
  } catch (err) {
...
const $677963a1596aa7ea$export$f558026a994b6051 = async (data, type) => {
  try {
    ...
    (0, $9872a30d54cb2189$export$de026b00723010c1)(
      'success',
      `${type.toUpperCase()} was successfully updated`,
    );
  } catch (err) {
...
const $a8ddc032179a0e8e$var$stripe = Stripe(
...
const $a8ddc032179a0e8e$export$8d5bdbf26681c0c2 = async (tourId) => {
  try {
    ...
    const session = await (0, $parcel$interopDefault($jANz3$axios))(
...
const $57c58b919921038b$export$7200a869094fec36 = async (
  name,
  email,
  password,
  passwordConfirm,
...
const $e18016dbdc1c1791$var$logOutBtn =
  document.querySelector('.nav__el--logout');
const $e18016dbdc1c1791$var$userPasswordForm = document.querySelector(
  '.form-user-password',
);
const $e18016dbdc1c1791$var$bookBtn = document.getElementById('book-tour');
//delegation
if ($e18016dbdc1c1791$var$mapBox)
  (0, $567099f3ebcb8bdf$export$4c5dd147b21b9176)($e18016dbdc1c1791$var$mapBox);
if ($e18016dbdc1c1791$var$loginForm)
  $e18016dbdc1c1791$var$loginForm.addEventListener('submit', (e) => {
    e.preventDefault();
    //values
...
if ($e18016dbdc1c1791$var$logOutBtn)
  $e18016dbdc1c1791$var$logOutBtn.addEventListener('click', (event) => {
    event.preventDefault();
    (0, $8f9e48ecb391b951$export$a0973bcfe11b05c9)();
  });
const $e18016dbdc1c1791$var$reviewsContainer =
  document.querySelector('.reviews');
const $e18016dbdc1c1791$var$btnLeft = document.querySelector(
  '.reviews__btn--left',
);
const $e18016dbdc1c1791$var$userDataForm =
  document.querySelector('.form-user-data');
const $e18016dbdc1c1791$var$btnRight = document.querySelector(
  '.reviews__btn--right',
);
if (
  $e18016dbdc1c1791$var$reviewsContainer &&
  $e18016dbdc1c1791$var$btnLeft &&
  $e18016dbdc1c1791$var$btnRight
) {
  const cardWidth = 396;
...
if ($e18016dbdc1c1791$var$userDataForm)
  $e18016dbdc1c1791$var$userDataForm.addEventListener('submit', (e) => {
    e.preventDefault();
...
if ($e18016dbdc1c1791$var$userPasswordForm)
  $e18016dbdc1c1791$var$userPasswordForm.addEventListener(
    'submit',
    async (e) => {
      e.preventDefault();
...
if ($e18016dbdc1c1791$var$bookBtn)
  $e18016dbdc1c1791$var$bookBtn.addEventListener('click', (el) => {
    el.target.textContent = 'Processing...';
    const { tourId: tourId } = el.target.dataset;
    (0, $a8ddc032179a0e8e$export$8d5bdbf26681c0c2)(tourId);
  });
const $e18016dbdc1c1791$var$signupForm =
  document.querySelector('.form--signup');
if ($e18016dbdc1c1791$var$signupForm)
  $e18016dbdc1c1791$var$signupForm.addEventListener('submit', (e) => {
    e.preventDefault(); // هاد أهم سطر — بيمنع الإرسال الطبيعي
    const name = document.getElementById('name').value;
    const email = document.getElementById('email').value;
    const password = document.getElementById('password').value;
    const passwordConfirm = document.getElementById('passwordConfirm').value;
    (0, $57c58b919921038b$export$7200a869094fec36)(
      name,
      email,
      password,
      passwordConfirm,
